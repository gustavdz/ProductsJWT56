@extends('layouts.app')
@section('topnavbar','Editar Proforma')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="paidform" class="form-control" name="paidform" value="{{old('paidform',$proyecto->paidform)}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<script>
    function init_daterangepicker_rangedate() {
        ...
        console.log('init_daterangepicker_rangedate');

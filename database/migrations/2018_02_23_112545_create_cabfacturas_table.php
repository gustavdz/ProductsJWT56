...
class CreateCabfacturasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cabfacturas', function (Blueprint $table) {
            ...
            $table->decimal('totalBruto',8,2)->default(0);
            $table->decimal('totalDscto',8,2)->default(0);
            $table->decimal('totalTax1',8,2)->default(0);
            $table->decimal('totalTax2',8,2)->default(0);
            $table->decimal('totalNeto',8,2)->default(0);
